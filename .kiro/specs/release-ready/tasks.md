...
- [ ] 1. Create CI workflow
  - [ ] 1.1 Create `.github/workflows/ci.yml` with fmt, clippy, test, and schema validation steps
...
- [ ] 2. Create release workflow
  - [ ] 2.1 Create `.github/workflows/release.yml` for crates.io publishing
...
- [ ] 3. Update crate metadata for crates.io
  - [ ] 3.1 Add metadata to `builddiag-types/Cargo.toml`
    - Add description, repository, homepage, keywords, categories
    - _Requirements: 3.1, 3.2_
  - [ ] 3.2 Add metadata to `builddiag-domain/Cargo.toml`
    - Add description, repository, homepage, keywords, categories
    - _Requirements: 3.1, 3.2_
  - [ ] 3.3 Add metadata to `builddiag-repo/Cargo.toml`
    - Add description, repository, homepage, keywords, categories
    - _Requirements: 3.1, 3.2_
  - [ ] 3.4 Add metadata to `builddiag-checks/Cargo.toml`
    - Add description, repository, homepage, keywords, categories
    - _Requirements: 3.1, 3.2_
  - [ ] 3.5 Add metadata to `builddiag-render/Cargo.toml`
    - Add description, repository, homepage, keywords, categories
    - _Requirements: 3.1, 3.2_
  - [ ] 3.6 Add metadata to `builddiag-app/Cargo.toml`
    - Add description, repository, homepage, keywords, categories
    - _Requirements: 3.1, 3.2_
  - [ ] 3.7 Add metadata to CLI crate `builddiag/Cargo.toml`
  ...
  - [ ] 3.8 Write property test for crate metadata completeness
    - **Property 1: Crate Metadata Completeness**
    - Verify all workspace crates have required metadata fields
    - **Validates: Requirements 3.1, 3.2**

- [ ] 4. Create CHANGELOG
  - [ ] 4.1 Create `CHANGELOG.md` following keep-a-changelog format
...
- [ ] 6. Add unit tests for builddiag-checks
  ...
  - [ ] 6.2 Add tests for `check_msrv_consistent`
    ...
    - _Requirements: 5.1, 5.2_
  - [ ] 6.3 Add tests for `check_toolchain_pinning`
